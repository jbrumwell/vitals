...
Health.prototype.add = function(pids) {    
...
Health.prototype.remove = function(pids) {       
...
Health.prototype._filter = function(fn) {
    var out = [],
        _this = this,         
...
Health.prototype.get = function(pids, one, cb) {
    var ret = [];
...
Health.prototype._run = function() {
    var _this = this,
